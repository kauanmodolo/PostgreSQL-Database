-- ALUNO: KAUAN MODOLO CARRIÇO
-- TURMA: CC1N

-- Criar o usuário e definindo sua senha:
\c postgres postgres;
CREATE USER kauan WITH ENCRYPTED PASSWORD '9540' LOGIN CREATEDB CREATEROLE;


-- Criar o banco de dados:
DROP DATABASE IF EXISTS uvv;
CREATE DATABASE uvv WITH owner kauan
TEMPLATE template0
encoding UTF8 LC_COLLATE 'pt_BR.UTF-8' LC_CTYPE 'pt_BR.UTF-8'
allow_connections true;


-- Usar o banco de dados sem precisar colocar a senha do usuário:
\c "dbname=uvv user=kauan password=9540";


-- Criar o schema e suas permissões ao usuário:
DROP schema if exists lojas;
CREATE schema lojas;
ALTER schema lojas owner to kauan;
